...
map.getView().fit([8394975.222807, 1328846.277776, 8431362.483195, 1350783.453278], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">KOODALI VILLAGE PANCHAYATH ADMINISTATIVE MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (56 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS IS AN ADMINISTATIVE MAP OF KOODALI GRAMA PANCHAYTH ';
            }
